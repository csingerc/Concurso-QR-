    ...
    4: [
      {
        ...
        pregunta: "En South Wind, el único alérgeno presente en planta es el pescado. ¿Qué representa el mayor riesgo de contaminación cruzada por alérgenos externos?",
        opciones: [
          { texto: "El uso de utensilios compartidos entre líneas", correcta: false },
          { texto: "El ingreso de alimentos del personal desde el exterior de la planta", correcta: true },
          { texto: "El contacto entre distintas especies de pescado", correcta: false },
        ],
        feedbackCorrecto: "✅ Correcto. Dado que no se procesan otros alérgenos en planta, el riesgo principal es externo: personal que ingresa con alimentos que contienen gluten, lácteos, frutos secos, etc. Por eso existe prohibición de ingreso de alimentos.",
        feedbackIncorrecto: "❌ El riesgo de alérgenos externos proviene del personal. La prohibición de ingreso de alimentos es la barrera principal.",
      },
      {
        tema: "Gestión de Alérgenos",
        pregunta: "Un operario trae en su bolso una colación con maní. ¿Qué riesgo representa aunque no la consuma dentro de la planta?",
        opciones: [
          { texto: "Ninguno si no abre el envase dentro de la planta", correcta: false },
          { texto: "Riesgo de transferencia por contacto con manos, ropa o superficies antes de ingresar a proceso", correcta: true },
          { texto: "Solo es riesgo si trabaja en la línea de empaque", correcta: false },
        ],
        feedbackCorrecto: "✅ Correcto. Los alérgenos pueden transferirse por contacto indirecto — manos que tocaron el alimento antes de lavarse, ropa o superficies en vestuarios. La prohibición de ingreso es la barrera más efectiva.",
        feedbackIncorrecto: "❌ El riesgo existe aunque no se abra el envase. El contacto con manos o ropa puede transferir trazas de alérgeno al proceso.",
      },
      {
        tema: "Gestión de Alérgenos",
